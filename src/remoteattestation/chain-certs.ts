...
export const chainCerts: ChainCert[] = [
  {
    Subject:
      'CN=i-0bbf1bfe232b8c2ce.us-east-1.aws.nitro-enclaves,OU=AWS,O=Amazon,L=Seattle,ST=Washington,C=US',
    PublicKey: [
...
-----END CERTIFICATE-----`,
  ...
  {
    Subject:
      'CN=i-0bbf1bfe232b8c2ce-enc01919739a4258120.us-east-1.aws,OU=AWS,O=Amazon,L=Seattle,ST=Washington,C=US',
    PublicKey: [
