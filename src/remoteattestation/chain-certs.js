...
exports.chainCerts = void 0;
exports.chainCerts = [
    {
        Subject: 'CN=i-0bbf1bfe232b8c2ce.us-east-1.aws.nitro-enclaves,OU=AWS,O=Amazon,L=Seattle,ST=Washington,C=US',
        PublicKey: [
            4, 94, 210, 25, 193, 221, 145, 22, 243, 151, 251, 70, 49, 113, 193, 128,
            159, 60, 179, 47, 135, 77, 233, 22, 250, 90, 38, 73, 197, 82, 17, 118, 1,
            214, 8, 128, 11, 167, 144, 128, 73, 94, 199, 250, 187, 240, 148, 241, 186,
            63, 228, 236, 21, 124, 220, 103, 227, 40, 78, 65, 75, 144, 93, 150, 136,
            95, 111, 118, 255, 200, 14, 118, 48, 180, 46, 109, 1, 128, 96, 180, 153,
            132, 17, 153, 153, 16, 90, 18, 87, 147, 23, 170, 244, 223, 205, 66, 130,
        ],
        Cert: "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"
    },
    {
        Subject: 'L=Seattle,ST=WA,C=US,O=Amazon,OU=AWS,CN=f328800117de2542.zonal.us-east-1.aws.nitro-enclaves',
        PublicKey: [
    ...
    {
        Subject: 'CN=3106da7af89fbcbe.us-east-1.aws.nitro-enclaves,OU=AWS,O=Amazon,C=US',
        PublicKey: [
    ...
    {
        Subject: 'CN=i-0bbf1bfe232b8c2ce-enc01919739a4258120.us-east-1.aws,OU=AWS,O=Amazon,L=Seattle,ST=Washington,C=US',
        PublicKey: [
            4, 51, 170, 171, 212, 166, 106, 141, 0, 53, 157, 51, 144, 107, 19, 208,
            151, 49, 105, 177, 80, 213, 152, 33, 174, 55, 233, 150, 139, 41, 220, 119,
            150, 41, 26, 103, 0, 80, 122, 67, 165, 21, 102, 243, 146, 108, 172, 98,
            244, 50, 90, 46, 118, 108, 39, 125, 206, 235, 35, 78, 62, 169, 83, 129,
            250, 100, 68, 126, 146, 6, 160, 235, 133, 168, 166, 177, 213, 12, 60, 124,
            185, 237, 169, 67, 142, 228, 160, 239, 191, 208, 83, 5, 4, 73, 44, 89, 92,
        ],
        Cert: "-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"
    },
];
